...
class EuropeHealthtechProcurementResponseReadinessChecklistTests(unittest.TestCase):
    ...
    def test_buyer_language_and_cluster_links_exist(self):
        for phrase in [
            ...
            "Turn the checklist into a diagnostic scope",
            "europe-healthtech-cloud-trust-finops-diagnostic&amp;source=procurement-response-checklist",
            "no-credentials owner review before any patient data",

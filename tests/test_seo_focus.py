...
class SeoFocusTests(unittest.TestCase):
    ...
    def test_sitemap_prioritizes_primary_offer_and_secondary_finops_line(self):
        required = {
            "/",
            "/free-business-review/",
            "/services/ai-automation/",
            "/services/ai-automation/small-business/",
            "/services/whatsapp-automation/",
            "/services/whatsapp-automation/lead-management/",
            "/services/workflow-automation/",
            "/resources/lead-follow-up-automation-guide/",
            "/services/cloud-finops/",
            "/services/cloud-finops/cloud-cost-review/",
            "/case-studies/",

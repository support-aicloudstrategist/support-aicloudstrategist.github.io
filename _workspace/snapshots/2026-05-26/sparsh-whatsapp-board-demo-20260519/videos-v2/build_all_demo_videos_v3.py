...
ROOT=Path('/home/OpenClaw/.openclaw/workspace/reports/sparsh-whatsapp-board-demo-20260519/videos-v3')
...
def header_footer(d, package):
    ...
    # Clean contact footer: split into 2 rows to avoid overlap
    d.line((46,638,1234,638), fill=BORDER, width=2)
    d.text((46,653),'Contact resources',font=FONT['smallb'],fill=TEXT)
    ...
    d.text((230,650),row1,font=FONT['micro'],fill=MUTED)
    d.text((230,674),row2,font=FONT['micro'],fill=MUTED)
...
def render_video(pkg_key, ddir, images, audios, durs):
    ...
    out=ddir/f'aics-{pkg_key}-clinic-demo-v3.mp4'

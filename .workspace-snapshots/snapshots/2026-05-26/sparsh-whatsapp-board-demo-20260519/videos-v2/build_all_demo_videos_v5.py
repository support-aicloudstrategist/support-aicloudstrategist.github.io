...
ROOT=Path('/home/OpenClaw/.openclaw/workspace/reports/sparsh-whatsapp-board-demo-20260519/videos-v5')
...
def header_footer(d, package):
    ...
    # Clean minimal footer; full resource block is shown on welcome/closing slides
    d.line((46,646,1234,646), fill=BORDER, width=2)
    d.text((56,666),'aicloudstrategist.com',font=FONT['smallb'],fill=TEXT)
    d.text((320,666),'WhatsApp: +91 87963 02608',font=FONT['small'],fill=MUTED)
    d.text((710,666),'contact@aicloudstrategist.com',font=FONT['small'],fill=MUTED)
...
def title_slide(package, title, subtitle):
    ...
    d.text((105,502),'Resources: aicloudstrategist.com  •  WhatsApp +91 87963 02608  •  Voice line +91 80654 80898',font=FONT['micro'],fill=MUTED)
    d.text((105,522),'Email: contact@aicloudstrategist.com  •  Support: support@aicloudstrategist.com',font=FONT['micro'],fill=MUTED)
    return im
...
def closing_slide(package, title, body):
    ...
    rounded(d,(90,390,1190,620),NAVY,26,outline=NAVY)
    d.text((130,416),'Thank you',font=FONT['h2'],fill=GREEN)
    draw_multiline(d,'AICloudStrategist can show the demo first, understand the clinic process, and then suggest the smallest practical pilot. No patient medical records are needed for the demo.',(130,462),FONT['body'],WHITE,980,8)
    d.rounded_rectangle((130,548,1150,604), radius=18, fill=(18,35,65), outline=(67,90,125), width=1)
    d.text((154,558),'aicloudstrategist.com  •  WhatsApp +91 87963 02608  •  Voice line +91 80654 80898',font=FONT['micro'],fill=WHITE)
    d.text((154,580),'contact@aicloudstrategist.com  •  support@aicloudstrategist.com',font=FONT['micro'],fill=(210,225,245))
    return im
...
def render_video(pkg_key, ddir, images, audios, durs):
    ...
    out=ddir/f'aics-{pkg_key}-clinic-demo-v5.mp4'

...
ROOT=Path('/home/OpenClaw/.openclaw/workspace/reports/sparsh-whatsapp-board-demo-20260519/videos-v7')
...
def header_footer(d, package):
    ...
    # Premium contact footer: two clean rows, no long crowded line
    d.line((46,632,1234,632), fill=BORDER, width=2)
    d.rounded_rectangle((46,642,1234,704), radius=18, fill=(255,255,255), outline=BORDER, width=1)
    y1, y2 = 652, 678
    d.text((72,y1),'Website',font=FONT['micro'],fill=MUTED)
    d.text((72,y2),'aicloudstrategist.com',font=FONT['small'],fill=TEXT)
    d.text((392,y1),'WhatsApp',font=FONT['micro'],fill=MUTED)
    d.text((392,y2),'+91 87963 02608',font=FONT['small'],fill=TEXT)
    d.text((682,y1),'Voice line',font=FONT['micro'],fill=MUTED)
    d.text((682,y2),'+91 80654 80898',font=FONT['small'],fill=TEXT)
    d.text((952,y1),'Email / Support',font=FONT['micro'],fill=MUTED)
    d.text((952,y2),'contact@aicloudstrategist.com',font=FONT['micro'],fill=TEXT)
    d.text((952,692),'support@aicloudstrategist.com',font=FONT['micro'],fill=MUTED)
...
def render_video(pkg_key, ddir, images, audios, durs):
    ...
    out=ddir/f'aics-{pkg_key}-clinic-demo-v7.mp4'

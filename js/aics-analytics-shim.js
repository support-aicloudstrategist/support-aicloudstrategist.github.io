(function(){
  function record(name, options){
    ...
    var event={name:String(name||'event'),props:props,page:location.pathname,ts:new Date().toISOString()};
    ...
    try{
      ...
      arr.push(event); sessionStorage.setItem(key, JSON.stringify(arr.slice(-50)));
    }catch(e){}
